...
void FAbilitySet_GrantedHandles::TakeFromAbilitySystem(UOTAbilitySystemComponent* ASC)
{
	check(ASC);
...
UOTAbilitySet::UOTAbilitySet(const FObjectInitializer& ObjInit) : Super(ObjInit)
{
}

void UOTAbilitySet::GiveToAbilitySystem(UOTAbilitySystemComponent* ASC, FAbilitySet_GrantedHandles* OutGrantedHandles,
