...
UOTExperienceDefinition::UOTExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UOTExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UOTExperienceDefinition::UpdateAssetBundleData()
{
